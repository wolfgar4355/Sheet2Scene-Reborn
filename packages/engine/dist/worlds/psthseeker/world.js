export const PATHSEEKER_WORLD = {
    id: "pathseeker",
    key: "ps",
    label: "Pathseeker",
    description: "Monde de fantasy ancrée et de survie : sentiers dangereux, vertus et vices, exploration lente et choix difficiles.",
