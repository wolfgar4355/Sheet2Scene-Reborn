...
export const MQ_SKIRTS = [
  ...
  //
  {
    ...
    description:
      "Un simple tissu renforcé porté par les milices et éclaireurs. Mobilité maximale, protection minimale."
  },

  {
    ...
    description:
      "Kilt en cuir souple porté par les combattants tribaux et les pillards."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Une jupe fendue permettant des mouvements silencieux pour la chasse ou la traque."
  },

  {
    ...
    description:
      "Des lamelles cousues sur un tissu épais, apportant une protection légère."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Plaques rudimentaires fixées sur une base en cuir. Lourd mais robuste."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Aérée et conçue pour les climats arides. Offre fraîcheur et aisance de mouvement."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Une jupe portée dans les régions nordiques pour une meilleure isolation."
  },

  {
    ...
    eras: ["ancient-age", "age-of-heroes"],
    description:
      "Renforts en bois poli cousus sur un tissu, prisés des peuples forestiers."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Des segments rigides attachés ensemble pour protéger la hanche sans trop nuire à la mobilité."
  },

  {
    ...
    eras: ["dark-age", "high-kingdoms"],
    description:
      "Deux plaques métalliques suspendues, couvrant l’avant des cuisses."
  },
  ...
  //
  {
    ...
    description:
      "Absorbe la lumière et étouffe les pas. Parfaite pour assassins et éclaireurs nocturnes."
  },

  {
    ...
    description:
      "Infusé d’énergie orageuse, il protège contre les chocs électriques et les attaques soniques."
  },

  {
    ...
    description:
      "Le bois réagit subtilement aux attaques, se déplaçant pour protéger son porteur."
  },

  {
    ...
    description:
      "Chaque plaque est gravée de glyphes anciens qui dissipent partiellement l’énergie magique."
  },

  {
    ...
    eras: ["mythic-age"],
    description:
      "Fabriqué à partir d’un alliage astral fluide, il se déforme légèrement pour absorber les coups."
  }
] as const;
