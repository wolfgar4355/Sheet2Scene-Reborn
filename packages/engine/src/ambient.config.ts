...
export function getAmbientColor(): string {
  ...
  const colors = {
    spring:   { morning: '#aad8ff', day: '#89c2ff', evening: '#3b4f80', night: '#1a1f33' },
    summer:   { morning: '#ffef7b', day: '#fff530', evening: '#ff9962', night: '#2f1d25' },
    autumn:   { morning: '#ffd27b', day: '#ffe27a', evening: '#ff7943', night: '#3b110b' },
    winter:   { morning: '#d6d6ff', day: '#fffbd2', evening: '#c87941', night: '#2b1c12' },
  };
