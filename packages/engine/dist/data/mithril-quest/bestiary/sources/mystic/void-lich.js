...
export const VOID_LICH = {
    ...
    phases: [
        ...
        // ---------------------------------------------------------------------
        {
            ...
            tactics: { prefersAmbush: true }, // NOTE: anciennement tactics: ["Cibler lanceurs et soigneurs d'abord.",
...
// ---------------------------------------------------------------------
{ key: , "phase-2": , name: , "Noyau Singulier": , cr: , 20: , role: , "mythic-controller": , description:  };
...
stats: {
    ...
    "+17",
        dmg;
    "5d10+10 (void tendrils) + entropy burn",
        speed;
    "hover 40 ft, teleport 30 ft";
}
abilities: [
