// bows_prompts.ts — Prompts IA MQ pour tous les arcs

export const BOWS_PROMPTS = [
  {
    key: "shortbow",
    style: "hand-painted fantasy illustration, parchment shading, MQ aesthetic",
    prompt: `
...
Fond neutre parchemin, éclairage doux ambiance grimoire.
  ...
  {
    key: "longbow",
    style: "high-fidelity fantasy engraving, medieval archer vibe",
    prompt: `
...
Éclairage dramatique, rendu clair sur fond parchemin.
  ...
  {
    key: "elven_longbow",
    style: "ethereal elven craftsmanship, glowing lines, MQ enchanted",
    prompt: `
...
Fond parchemin doré légèrement texturé.
  ...
  {
    key: "composite_bow",
    style: "detailed composite design, leather bindings, realistic wood-grain",
    prompt: `
...
Style MQ peinture propre, rendu professionnel.
  ...
  {
    key: "storm_bow",
    style: "storm energy, crackling arcs, MQ magic effects",
    prompt: `
...
Arme légendaire MQ, magie modérée mais visible.
  ...
  {
    key: "shadowbow",
    style: "shadow magic, dark smoke effects, MQ occult aesthetic",
    prompt: `
...
Fond parchemin assombri, contraste élevé.
  ...
  {
    key: "sunflare_bow",
    style: "radiant light magic, holy glow, MQ mythic aesthetic",
    prompt: `
...
Fond parchemin doré avec halo léger.
  ...
  {
    key: "astral_longbow",
    style: "cosmic energy, astral runes, mythic celestial feel",
    prompt: `
