...
export const KRONTHAL = {
    ...
    // ---------------------------------------------------------------------
    {
        ...
        description: "Un maître du temps qui inverse initiative, réécrit les actions et " +
            ...
            tactics
    }]: { prefersAmbush: true }, // NOTE: anciennement tactics: ["Cibler les joueurs trop rapides.",
...
// ---------------------------------------------------------------------
{ key: , "phase-2": , name: , "Kron’Thal Fracturé — Seigneur des Paradoxes": , cr: , 25: , role: , "mythic-controller": , biomes: [], description: , "Le sorcier devient instable, existant en plusieurs états temporels. ":  };
+
