...
export const MQ_RACES_CONSTRUCTS = [
  {
    ...
    label: "Forgeborn",
    description:
      "Créatures forgées dans la braise et le métal. Leur cœur abrite une braise éternelle.",
    traits: [
...

  {
    ...
    label: "Golemkin",
    description:
      "Êtres animés par une magie runique ancienne. Ils sont composés de pierre, d’argile, de cristal ou de métal.",
    traits: [
      "Peau runique",
...

  {
    ...
    label: "Vivicraft",
    description:
      "Constructs alchimiques créés à partir de chair régénérée et de magie vitale. À mi-chemin entre vivant et artificiel.",
    traits: [
      "Régénération lente",
...

  {
    ...
    label: "Etherframe",
    description:
      "Esprits errants enfermé dans une enveloppe d’âme cristallisée. Semi-intangibles et sensibles aux flux arcaniques.",
    traits: [
...

  {
    ...
    label: "Clockwinder",
    description:
      "Automates conscients animés par un noyau mécanique. Leur esprit est précis, méthodique et logique.",
    traits: [
      "Précision mécanique",
      "Résistance au froid",
      "Mode analyse",
