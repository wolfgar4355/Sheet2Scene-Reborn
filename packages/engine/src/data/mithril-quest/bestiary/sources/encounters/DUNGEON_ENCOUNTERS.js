export const DUNGEON_ENCOUNTERS = [
    // 1–10 : Vermine & échos sombres
    {
        ...
        difficulty: "easy",
        description: "Petites créatures proliférant dans les zones abandonnées et effondrées.",
    },
    // 11–20 : Gardiens oubliés
    {
        ...
        difficulty: "standard",
        description: "Des sentinelles archaïques animées par de vieux enchantements.",
    },
    // 21–35 : Ombres rampantes
    {
        ...
        difficulty: "standard",
        description: "Des horreurs nocturnes qui glissent sur les murs et attaquent par surprise.",
    },
    // 36–50 : Horreurs des profondeurs
    {
        ...
        habitat: "deep-crypts",
        difficulty: "hard",
        description: "Créatures difformes attirées par le sang et les vibrations.",
    },
    // 51–65 : Prisonniers du Néant
    {
        ...
        difficulty: "hard",
        description: "Entités instables provenant de brèches fermées depuis longtemps.",
    },
    // 66–80 : Sectes interdites
    {
        ...
        difficulty: "hard",
        description: "Des fanatiques exécutant d'anciens rituels dans l’obscurité.",
    },
    // 81–90 : Apparitions tourmentées
    {
        ...
        difficulty: "deadly",
        description: "Esprits de prisonniers morts dans d’horribles circonstances.",
    },
    // 91–98 : Créatures mythiques enfermées
    {
        ...
        difficulty: "deadly",
        description: "Des monstres légendaires confinés depuis des siècles sous terre.",
    },
    // 99–100 : Terreur du Gouffre
    {
        ...
        habitat: "abyss-core",
        difficulty: "deadly",
        description: "Une entité titanesque sculptée dans le vide vivant.",
    },
];
