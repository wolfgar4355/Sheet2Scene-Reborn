...
export const MQ_MOUNT_ARMORS = [
  ...
  //
  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Une armorure de cuir basique offrant une protection minimale."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Plus solide, souvent utilisée par les patrouilles montées."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Protection de cuir pour les sangliers de guerre."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Une protection légère adaptée aux montures rapides."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Armure légère conçue pour ne pas gêner les mouvements félins."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Adaptée aux longues traversées dans les régions arides."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Une armure de mailles légère protégeant les zones vitales."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Une armure chaude conçue pour les régions montagneuses."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Idéale pour les climats extrêmes et les terrains escarpés."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Peau épaissie offrant une excellente protection naturelle."
  },
  ...
  //
  {
    ...
    eras: ["mythic-age"],
    description:
      "Forgée avec des écailles de wyverne offrant une protection exceptionnelle."
  },

  {
    ...
    eras: ["mythic-age"],
    description:
      "Léger, aérodynamique et imprégné de magie céleste."
  },

  {
    ...
    description:
      "Un équipement vivant qui renforce les barrières magiques du porteur."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Une protection surnaturelle qui se fond dans l'obscurité."
  },

  {
    ...
    eras: ["mythic-age"],
    description:
      "Forgée dans un métal sacré, brillamment radiant."
  }
] as const;
