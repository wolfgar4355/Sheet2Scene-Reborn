...
export const UTILITY_SPELLS = [
    ...
    //
    {
        ...
        description: "Le sort imprègne un objet d’une lueur stable, permettant d’explorer les cavernes ou de lire "
    ...
    },
    {
        ...
        description: "Le lanceur peut soulever ou tirer un objet léger à portée, ouvrir une porte déverrouillée "
    ...
    //
    {
        ...
        description: "Les flux arcaniques deviennent visibles sous la forme de filaments colorés, indiquant la présence "
    ...
    },
    {
        ...
        description: "Une fine pellicule psychique amortit les sons produits par le lanceur, facilitant les déplacements "
    ...
    //
    {
        ...
        description: "Les conversations à l’intérieur du voile ne peuvent pas être entendues depuis l’extérieur, "
    ...
    },
    {
        ...
        description: "Des bourrasques invisibles poussent le lanceur vers l’avant, lui permettant de couvrir rapidement "
    ...
    //
    {
        ...
        description: "En un clignement d’œil, le mage disparaît dans une étincelle bleutée et réapparaît quelques mètres "
    ...
    },
    {
        ...
        description: "Le sol se nivelle, les pierres se rangent sur le côté et les épines reculent, traçant un couloir "
    ...
    //
    {
        ...
        description: "Le sol est marqué de glyphes lumineux. Les créatures hostiles ressentent un malaise en entrant, "
