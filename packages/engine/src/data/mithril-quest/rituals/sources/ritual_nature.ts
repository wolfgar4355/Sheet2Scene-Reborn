...
export const RITUAL_NATURE: Ritual[] = [
  {
    id: "calm_storm",
    ...
    description:
      "Dissipe une tempête locale et stabilise les conditions météorologiques."
  },
  {
    id: "wild_growth",
    ...
    description:
      "Accélère la croissance d'une forêt ou restaure un écosystème affaibli."
  },
  {
    id: "beast_bond",
    label: "Pacte Animal",
    ...
    description:
      "Lie un gardien animal au druide ou rôdeur, renforçant leur connexion."
  },
  {
    id: "call_grove",
    ...
    description:
      "Réveille un esprit sylvestre endormi afin qu'il protège ou guide le lanceur."
  },
  {
    id: "shape_weather",
    ...
    description:
      "Modifie la météo régionale pour plusieurs jours."
  },
  {
    id: "purify_land",
    ...
    description:
      "Supprime corruption, toxines et influences nécrotiques présentes dans la terre."
  },
  {
    id: "summon_beast",
    ...
    description:
      "Invoque un puissant esprit animal chargé de protéger une zone."
  },
  {
    id: "speak_land",
