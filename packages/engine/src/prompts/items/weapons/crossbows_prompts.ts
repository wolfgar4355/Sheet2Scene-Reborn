// crossbows_prompts.ts — Prompts IA MQ pour arbalètes

export const CROSSBOWS_PROMPTS = [
  {
    key: "light_crossbow",
    style: "wood+steel simple craftsmanship, MQ parchment aesthetic",
    prompt: `
...
Style aventurier débutant. Fond parchemin, éclairage doux.
  ...
  {
    key: "heavy_crossbow",
    style: "heavy steel limbs, realistic shadows, medieval discipline",
    prompt: `
...
Ambiance soldat MQ, rendu sérieux.
  ...
  {
    key: "hand_crossbow",
    style: "compact stealth gear, assassin vibe",
    prompt: `
...
Style discret MQ, éclairage contrasté.
  ...
  {
    key: "siege_slinger",
    style: "giant siege weapon, brutal engineering",
    prompt: `
...
Fond parchemin sombre, ambiance guerre médiévale MQ.
  ...
  {
    key: "tribal_boltbow",
    style: "primitive carved wood, tribal patterns",
    prompt: `
...
Ambiance ancienne tribu MQ, teintes ocres.
...

  {
    ...
    style: "sharpened engineering, sniper vibe, fantasy elite",
    prompt: `
...
Ambiance tireur d’élite MQ.
...

  {
    ...
    style: "glowing arcane components, magic tech mix",
    prompt: `
...
Style technomagique MQ maîtrisé.
...

  {
    ...
    style: "shadow magic, dark aura, cursed aesthetic",
    prompt: `
...
Arme légendaire MQ sombre.
...

  {
    ...
    style: "radiant holy glow, celestial craftsmanship",
    prompt: `
...
Ambiance divine MQ.
  ...
  {
    key: "astral_arbalest",
    style: "cosmic energy bow, floating runes, mythic",
    prompt: `
