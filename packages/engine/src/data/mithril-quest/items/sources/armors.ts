...
export const ARMORS = [
  ...
  //
  {
    ...
    description:
      "Une armure de tissu épais offrant une faible protection mais facilement accessible."
  },

  {
    ...
    description:
      "Du cuir tanné renforcé protégeant légèrement tout en restant très maniable."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Une armure en cuir renforcée de clous métalliques pour une meilleure protection."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Une armure malléable faite de fils d’ombre, parfaite pour les assassins et rôdeurs nocturnes."
  },
  ...
  //
  {
    ...
    eras: ["ancient-age"],
    description:
      "Un assemblage de peaux épaisses fournissant une protection rudimentaire."
  },

  {
    ...
    description:
      "Une chemise métallique offrant une bonne protection contre les coups tranchants."
  },
...

  {
    ...
    description:
      "Une armure métallisée partielle, offrant une excellente protection tout en gardant une certaine flexibilité."
  },
  ...
  //
  {
    ...
    eras: ["dark-age"],
    description:
      "Un tissu renforcé d’anneaux métalliques offrant une protection correcte."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Une armure complète en anneaux entrelacés, très résistante."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Des plaques métalliques renforcées montées sur un support en cuir."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "La meilleure protection physique disponible, une armure intégrale sans faille."
  },
  ...
  //
  {
    ...
    eras: ["mythic-age"],
    description:
      "Forgée à partir d’écailles d’un dragon ancien, elle confère protection et résistance élémentaire."
  },

  {
    ...
    eras: ["mythic-age"],
    description:
      "Une armure légère faite de lumière cristallisée, flottant légèrement autour du porteur."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Un ensemble maudit provenant des profondeurs du Néant, murmurant à ceux qui l'approchent."
  }
] as const;
