...
// ─────────────────────────────────────────────────────────────
export const MQ_SHIELD_PROMPT_CONFIGS = {
    // ───────────────────
    // Boucliers communs
    // ───────────────────
    buckler: {
        basePrompt: "small round metal buckler, simple construction, wooden grip, handmade medieval forging",
    ...
    light_shield: {
        basePrompt: "light wooden shield reinforced with thin metal bands, practical and common among early soldiers",
    ...
    steel_shield: {
        basePrompt: "solid round steel shield, polished surface, reinforced boss in the center",
        materialHints: ["steel"],
    ...
    heavy_shield: {
        basePrompt: "large rectangular heavy shield, reinforced metal borders, battlefield wear and dents",
    ...
    tower_shield: {
        basePrompt: "massive tower shield, nearly full-body sized, thick wood core, iron front plating",
    ...
    tribal_hide_shield: {
        basePrompt: "primitive hide shield stretched over wooden frame, decorated with tribal war paints and symbols",
    ...
    // ───────────────────
    blessed_shield: {
        basePrompt: "holy blessed shield glowing faintly with radiant light, engraved runes, divine craftsmanship",
    ...
    obsidian_guard: {
        basePrompt: "dark obsidian shield, polished volcanic glass surface, faint internal glow, cursed aura",
    ...
    celestial_aegis: {
        basePrompt: "floating celestial shield, luminous crystalline patterns, divine geometry, soft glowing aura",
    ...
    titan_plate_wall: {
        basePrompt: "colossal titan-forged wall shield, ancient sacred metal, runes of giants, massive and unbreakable",
