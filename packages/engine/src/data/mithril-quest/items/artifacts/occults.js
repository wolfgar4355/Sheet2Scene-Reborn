export const MQ_ARTIFACTS_OCCULTS = [
    {
        key: "voidblood_talisman",
        label: "Talisman of Voidblood",
        description: "A dark organic crystal carved into a talisman. It pulses like a living heart.",
        type: "artifact",
        category: "occult",
        subtype: "void",
        metadata: {
    ...
    },
    {
        ...
        description: "Spectral chain links that jingle even without physical contact.",
        type: "artifact",
        category: "occult",
        subtype: "spirit",
        metadata: {
    ...
    },
    {
        ...
        description: "A cracked skull that sometimes whispers your name in an unknown tongue.",
        type: "artifact",
        category: "occult",
        subtype: "necrotic",
        metadata: {
    ...
    },
    {
        key: "eldritch_eye",
        label: "Eldritch Eye",
        description: "A floating eyeball trapped inside a fractured glass sphere.",
        type: "artifact",
        category: "occult",
        subtype: "eldritch",
        metadata: {
    ...
    },
    {
        ...
        description: "Translucent strings vibrating with a sound that shouldn't exist.",
        type: "artifact",
        category: "occult",
        subtype: "sound",
        metadata: {
    ...
    },
    {
        ...
        description: "A cloak woven from liquid shadows trying to swallow nearby light.",
        type: "artifact",
        category: "occult",
        subtype: "shadow",
        metadata: {
    ...
    },
    {
        ...
        description: "A screaming stone idol carved with shifting, impossible shapes.",
        type: "artifact",
        category: "occult",
        subtype: "fear",
        metadata: {
    ...
    },
    {
        key: "ashen_tongue",
        label: "Ashen Tongue",
        description: "A fossilized organ radiating a sinister, dry heat.",
        type: "artifact",
        category: "occult",
        subtype: "curse",
        metadata: {
    ...
    },
    {
        ...
        description: "A glass-like fragment reflecting things that aren't present.",
        type: "artifact",
        category: "occult",
        subtype: "void",
        metadata: {
    ...
    },
    {
        key: "abyssal_relic",
        label: "Abyssal Relic",
        description: "A heavy stone engraved with writhing abyss glyphs, exuding pressure.",
        type: "artifact",
        category: "occult",
        subtype: "abyss",
        metadata: {
