...
export const ITEM_POSES = [
    ...
    // --------------------------------------------------------------------------
    {
        ...
        prompt: "ultra detailed studio lighting, realistic object render, sharp edges, volumetric shading",
    ...
    },
    {
        ...
        prompt: "isometric product photography, dramatic rim light, high-detail texture",
    ...
    // --------------------------------------------------------------------------
    {
        ...
        seed: 33211,
        usage: ["inventory", "ui"],
        prompt: "anime cel-shaded style, bold outlines, soft gradients, vibrant colors",
        tags: ["anime", "celshade"],
    },
    // --------------------------------------------------------------------------
    // MANGA
    // --------------------------------------------------------------------------
    {
        ...
        prompt: "manga-style monochrome, black ink lines, halftone shading, crisp silhouette",
        tags: ["manga", "ink"],
    },
    // --------------------------------------------------------------------------
    // CARTOON US
    // --------------------------------------------------------------------------
    {
        ...
        seed: 55123,
        usage: ["game-ui", "icons"],
        prompt: "american cartoon style, thick lines, expressive shape, bright saturated colors",
        tags: ["cartoon", "flat"],
    },
    // --------------------------------------------------------------------------
    // BLUEPRINT 3D
    // --------------------------------------------------------------------------
    {
        ...
        prompt: "blueprint render, white technical lines on deep blue background, orthographic view",
