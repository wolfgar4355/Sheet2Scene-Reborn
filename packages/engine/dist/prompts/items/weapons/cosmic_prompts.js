// cosmic_prompts.ts — Armes stellaires MQ
export const COSMIC_PROMPTS = [
    {
        key: "astral_sword",
        style: "cosmic blade, shimmering edges, nebula colors",
        prompt: `
...
Style mythique MQ cosmique.
    ...
    {
        key: "void_sting",
        style: "thin dark blade, void energy crackles",
        prompt: `
...
Aura inquiétante mais sobre MQ.
    ...
    {
        key: "starbreaker",
        style: "heavy cosmic hammer, meteor-metal",
        prompt: `
...
Ambiance MQ céleste.
    ...
    {
        key: "comet_lance",
        style: "long sleek spear, icy cosmic trail",
        prompt: `
...
Arme MQ mythique espace.
    ...
    {
        key: "eclipse_blade",
        style: "dark crescent blade, solar-lunar contrast",
        prompt: `
