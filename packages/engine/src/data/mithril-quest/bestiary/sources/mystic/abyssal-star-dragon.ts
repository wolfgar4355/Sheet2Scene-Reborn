...
tactics: ["Reste en vol constant, alterne entre bombardements à distance et piqués brutaux sur les cibles isolées.",
...
abilities: [
    ...
    // PHASE 2 — Cœur Abyssal Conscient
    {
      ...
      tactics: { prefersAmbush: true }, // NOTE: anciennement // NOTE (fix-fantasy v2 auto-commented)
tactics: ["Abandonne la mobilité classique pour un contrôle total du terrain via distorsions gravitationnelles.",
