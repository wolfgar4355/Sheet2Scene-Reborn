// polearms_prompts.ts — Prompts IA MQ pour armes d’hast

export const POLEARMS_PROMPTS = [
  {
    key: "spear",
    style: "simple wood shaft, primitive metal tip, grounded realism",
    prompt: `
...
Look ancien, utilitaire. Fond parchemin clair MQ.
  ...
  {
    key: "pike",
    style: "long disciplined weapon, army formation feel",
    prompt: `
...
Ambiance rangées de soldats MQ.
  ...
  {
    key: "halberd",
    style: "multi-purpose blade, medieval iconic polearm",
    prompt: `
...
Style bataille MQ héroïque.
  ...
  {
    key: "glaive",
    style: "curved blade elegance, fantasy warrior",
    prompt: `
...
Lame acérée MQ, ambiance sobre.
  ...
  {
    key: "bardiche",
    style: "large brutal blade, heavy infantry",
    prompt: `
...
Ambiance unité lourde MQ.
  ...
  {
    key: "fauchard",
    style: "hooked blade, exotic medieval look",
    prompt: `
...
Design MQ propre sans surcharge.
  ...
  {
    key: "naginata",
    style: "long curved blade, refined martial discipline",
    prompt: `
...
Style arts martiaux MQ, 0 IP.
  ...
  {
    key: "storm_spear",
    style: "thunder energy, crackling aura",
    prompt: `
...
Arme combattant des tempêtes MQ.
...

  {
    ...
    style: "radiant divine weapon, bright engravings",
    prompt: `
...
Arme légendaire MQ lumineuse.
  ...
  {
    key: "titan_spike",
    style: "colossal scale, thick metal, mythic brute force",
    prompt: `
