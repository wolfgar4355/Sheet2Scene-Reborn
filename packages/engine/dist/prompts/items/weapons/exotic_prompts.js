// exotic_prompts.ts — Armes exotiques MQ
export const EXOTIC_PROMPTS = [
    {
        key: "whip",
        style: "leather braid, dynamic curve, adventurer gear",
        prompt: `
...
Style aventurier MQ, fond parchemin.
    ...
    {
        key: "chain_whip",
        style: "segmented chain, metallic spikes, danger aesthetic",
        prompt: `
...
Ambiance agressive MQ.
    ...
    {
        key: "spiked_chain",
        style: "heavy brutal chain, thick spikes",
        prompt: `
...
Style MQ brutal, ambiance sombre.
    ...
    {
        key: "kusarigama",
        style: "scythe + chain hybrid, martial discipline",
        prompt: `
...
Éclairage doux, fond parchemin MQ.
    ...
    {
        key: "gnome_buzzblade",
        style: "mechanical spinning blade, gnomish tech",
        prompt: `
...
Ambiance gnome MQ inventive.
    ...
    {
        key: "monk_bo",
        style: "smooth wood staff, disciplined stance",
        prompt: `
Bâton de Moine (Bo).
...
Esthétique martial MQ propre et neutre.
    ...
    {
        key: "nunchaku",
        style: "dual sticks, simple rope, motion blur subtle",
        prompt: `
...
Style MQ arts martiaux sans dériver vers IP.
    ...
    {
        key: "double_blade",
        style: "dual-ended blade, fantasy agility",
        prompt: `
...
Métal clair, proportion fluide.
    ...
    {
        key: "cultist_martial_blade",
        style: "dark ritualistic carvings, necrotic aura",
        prompt: `
...
Ambiance noire MQ.
    ...
    {
        key: "infernal_chain",
        style: "burning demonic metal, fiery glow",
        prompt: `
...
Arme légendaire MQ infernale.
    ...
    {
        key: "stellar_blade",
        style: "cosmic steel, star-runes, radiant edges",
        prompt: `
