export const LAVA_ENCOUNTERS = [
    ...
    // 51–65 : Démons du Brasier
    {
        ...
        difficulty: "hard",
        description: "Les murs fondent sous leur présence, distordant la réalité thermique.",
    },
    // 66–80 : Titans de Cendres
    {
        ...
        difficulty: "hard",
        description: "Géants de roche vivante portant des cicatrices incandescentes.",
    },
    // 81–90 : Prédateurs thermiques d’élite
    {
        ...
        difficulty: "hard",
        description: "Chasseurs félins ignés, invisibles dans la chaleur ondulante.",
    },
    ...
    // 99–100 : Boss Mythique — Titan du Cœur Magmatique
    {
        ...
        habitat: "mythic-core",
        difficulty: "deadly",
        description: "Une entité colossale née du noyau en fusion, dotée d’un pouvoir ancien.",
    },
];
