...
export default function TransitionLayer(props = {}) {
    ...
    const season = props.overrideSeason ?? seasonData.name ?? "summer";
    const dayPhase = props.overridePhase ?? seasonData.phase ?? "day";
    const weather = props.overrideWeather ?? seasonData.weather ?? "clear";
    const intensity = props.overrideIntensity ?? seasonData.intensity ?? 0;
    /* ------------------------------------------------------------------------ */
    /* LUMIÈRE GLOBALE                                                           */
    /* ------------------------------------------------------------------------ */
