...
export const GEAR = [
  ...
  // ---------------------------------------------------------------------
  {
    ...
    description:
      "Une cape robuste protégeant de la pluie et du vent, portée par la plupart des voyageurs."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Des bottes simples mais confortables pour de longues marches."
  },

  {
    ...
    description:
      "Large et déformé, idéal pour les climats ensoleillés ou pluvieux."
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Un ensemble comprenant des rations, une corde, une lanterne, une couverture et une gourde."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Contient du matériel léger : jumelles, cartes, craie et rations sèches."
  },

  {
    ...
    description:
      "Comprend silex, aiguilles, fil, herbes simples et outils de base."
  },
...

  {
    ...
    eras: ["dark-age"],
    description:
      "Utilisées pour stabiliser des cordes, bloquer des portes ou escalader."
  },

  {
    ...
    description:
      "Contient clés, marteau, clous, limes et outils de réparation simples."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Bandages, aiguilles, herbes coagulantes et compresses."
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    eras: ["arcane-renaissance"],
    description:
      "Un petit cristal amplifiant légèrement les sorts mineurs."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Une lanterne révélant la présence d’esprits et d’énergies arcaniques."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Utilisée pour tracer cercles runiques et glyphes d’invocation."
  },
  ...
  // ---------------------------------------------------------------------
  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Des robes portées lors de rites religieux ou spirituels."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Un masque sacré utilisé lors de danses ancestrales."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Des tambours puissants utilisés pour galvaniser les troupes."
  },
