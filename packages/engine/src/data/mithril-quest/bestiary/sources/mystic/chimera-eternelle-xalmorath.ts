...
export const XALMORATH: MythicBoss = {
  ...
  summary:
    "Créature expérimentale née d’une fusion bestiale impossible, Xal’morath mute " +
...
tactics: ["Bondit sur la cible la plus faible.",
...
abilities: [
    ...
    // PHASE 2 — Forme Instable Suprême
    {
      ...
      tactics: { prefersAmbush: true }, // NOTE: anciennement // NOTE (fix-fantasy v2 auto-commented)
tactics: ["Contrôle de zone par altérations chaotiques.",
