...
export const FANTASY_ARTIFACTS = [
    {
        key: "ember-heart",
        ...
        weight: 1,
        attunement: true,
        effect: "Augmente grandement les capacités liées au feu. Permet de lancer des sorts de feu avancés.",
    ...
    },
    {
        ...
        weight: 1,
        attunement: true,
        effect: "Donne un avantage aux jets d’Intuition et de Tromperie, et permet de percer les illusions mineures.",
