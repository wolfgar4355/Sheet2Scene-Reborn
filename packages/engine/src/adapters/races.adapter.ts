...
// Chaque entrée du module RACES est un tableau de races.
// On reconstruit un type Race propre à partir du contenu réel.
 ...
 */
export function getRacesByType(): Record<string, Race[]> {
