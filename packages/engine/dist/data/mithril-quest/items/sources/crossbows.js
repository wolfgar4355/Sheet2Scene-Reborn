...
export const MQ_CROSSBOWS = [
    ...
    // ─────────────────────────────────────────────
    {
        ...
        description: "Une arbalète facile à manier, idéale pour les soldats débutants et les tireurs embusqués."
    },
    {
        key: "tribal_boltbow",
        ...
        properties: ["loading"],
        eras: ["ancient-age"],
        description: "Une arbalète primitive en bois brut, renforcée de ligatures et de tendons."
    },
    // ─────────────────────────────────────────────
    //  B — MARTIAL CROSSBOWS
    // ─────────────────────────────────────────────
    {
        ...
        description: "Puissante et précise, mais lente à recharger. Capable de transpercer des armures épaisses."
    },
    {
        key: "hand_crossbow",
        ...
        description: "Une petite arbalète discrète, prisée des voleurs, assassins et aventuriers urbains."
    },
    {
        key: "siege_slinger",
        ...
        eras: ["dark-age"],
        description: "Un modèle massif inspiré des balistes : lent mais terriblement destructeur."
    },
    {
        ...
        properties: ["two-handed", "loading"],
        eras: ["high-kingdoms", "arcane-renaissance"],
        description: "Une arbalète finement calibrée pour les tireurs d’élite et chasseurs de monstres."
    },
    // ─────────────────────────────────────────────
    //  C — MAGICAL CROSSBOWS
    // ─────────────────────────────────────────────
    {
        ...
        description: "Infusée d’énergie éthérique, elle peut tirer plusieurs carreaux avant de devoir être rechargée."
    },
    {
        ...
        description: "Une arbalète imprégnée d’énergie du Néant, tirant des carreaux qui drainent la vitalité."
    },
    {
        ...
        description: "Bénie par les prêtres du Soleil, elle tire des projectiles de lumière purifiante."
    },
    // ─────────────────────────────────────────────
    //  D — MYTHIC CROSSBOW
    // ─────────────────────────────────────────────
    {
        ...
        eras: ["mythic-age"],
        description: "Forgée dans les vents stellaires, elle projette des carreaux d'énergie pure arrachée aux courants cosmiques."
    }
];
