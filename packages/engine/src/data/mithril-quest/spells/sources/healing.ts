...
export const HEALING_SPELLS: Spell[] = [
  ...
  //
  {
    ...
    shortSummary:
      "Rallume faiblement la vitalité d’une créature.",
    description:
      "Une étincelle verte traverse la peau de la cible, apaisant une douleur et redonnant juste assez "
  ...
  //
  {
    ...
    shortSummary:
      "Une courte prière soigne légèrement plusieurs alliés.",
    description:
      "Le lanceur murmure une invocation aux esprits bienveillants. Ceux-ci répondent par une vague "
  ...
  //
  {
    ...
    shortSummary:
      "Crée une zone où les blessures se referment lentement.",
    description:
      "Pendant toute la durée du sort, les créatures alliées qui se reposent dans la zone ressentent "
  ...
  },
  {
    ...
    shortSummary:
      "Supprime un affaiblissement modéré.",
    description:
      "Le sort dissipe un poison mineur, une fièvre surnaturelle, une cécité ou une surdité causée par la magie, "
  ...
  //
  {
    ...
    availableInEras: ["high-kingdoms"],
    shortSummary:
      "Ramène une créature mourante à la vie consciente.",
    description:
      "Le sort arrache l’âme de la cible au bord du gouffre, la rattachant au monde matériel. "
  ...
  },
  {
    ...
    shortSummary:
      "Une pluie sacrée soigne et nettoie les alliés.",
    description:
      "De fines gouttes de lumière tombent sur la zone, soignant des blessures modérées et "
  ...
  //
  {
    ...
    shortSummary:
      "Fait repousser membres, yeux ou organes perdus.",
    description:
      "Le sort déclenche une croissance organique rapide, tissant muscles, nerfs et os à partir de "
  ...
  //
  {
    ...
    availableInEras: ["mythic-age"],
    shortSummary:
      "Un miracle restaure entièrement une troupe entière.",
    description:
      "Un réseau de lignes de force relie toutes les créatures alliées dans la zone. "
