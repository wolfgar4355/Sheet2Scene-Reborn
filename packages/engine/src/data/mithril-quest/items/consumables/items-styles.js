...
// ============================================================================
export const MQ_ITEM_STYLES = [
    {
        key: "realistic-like",
        label: "Réalisme AAA",
        description: "Style cinéma/jeu vidéo AAA, matériaux réalistes, ombres fidèles.",
        prompt: "ultra detailed, physically based rendering, realistic materials, accurate shadows, high-end video game asset, 8k texture",
    ...
    },
    {
        ...
        prompt: "anime rendering, clean linework, vibrant cel-shading, stylized highlights, modern anime prop design",
    ...
    },
    {
        ...
        prompt: "manga-style black and white, screentones, bold line art, inked shading, high contrast",
    ...
    },
    {
        ...
        prompt: "american cartoon style, bold shapes, smooth outlines, expressive exaggeration, colorful prop design",
    ...
    },
    {
        ...
        prompt: "3d printable stl, clean geometry, no textures, single-color matte surface, optimal for 3D printing, high detail sculpt",
    ...
    },
    {
        ...
        prompt: "mithril quest style, ancient runes, mythic glow, arcane mist, enchanted artifact rendering, mystical lighting",
