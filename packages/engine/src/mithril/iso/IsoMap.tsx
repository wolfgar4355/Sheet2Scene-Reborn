...
function tileColor(kind: TileKind) {
  switch (kind) {
    case "grass":
      return "rgba(90,140,85,1)";
    case "dirt":
      return "rgba(140,110,75,1)";
    case "stone":
      return "rgba(120,120,130,1)";
    case "water":
      return "rgba(70,110,170,1)";
    default:
...
export const IsoMap = memo(function IsoMap({
  ...
  /**
   * Ordre de rendu isométrique
   * → tri par diagonales (x + y)
   */
  const order = useMemo(() => {
