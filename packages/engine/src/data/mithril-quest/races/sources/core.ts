...
export const MQ_RACES_CORE = [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    label: "Humain",
    description:
      "Polyvalents et adaptables, les humains prospèrent dans toutes les époques.",
    traits: [
      "Adaptabilité",
  ...
  // --------------------------------------------------------------------------
  {
    ...
    label: "Elfe Haut-Né",
    description:
      "Élégants et érudits, ils maîtrisent la magie et les arts anciens.",
  ...
  },
  {
    ...
    description:
      "Rapides et agiles, les elfes sylvestres vivent en harmonie avec la nature.",
  ...
  // --------------------------------------------------------------------------
  {
    ...
    label: "Nain",
    description:
      "Robustes, endurants et fiers, les nains excellent dans les métiers et les combats.",
  ...
  // --------------------------------------------------------------------------
  {
    ...
    label: "Semi-homme",
    description:
      "Curieux et chanceux, ils voyagent souvent pour vivre des aventures inattendues.",
  ...
  // --------------------------------------------------------------------------
  {
    ...
    label: "Orc",
    description:
      "Puissants et agressifs, les orcs sont des guerriers redoutables.",
  ...
  // ---------------------------- ELFES x HUMAIN -----------------------------
  {
    ...
    description:
      "Hybride sylvestre agile, réceptif aux flux de la nature et de la magie.",
  ...
  },
  {
    ...
    description:
      "Issus de lignées secrètes, ils manipulent ombres et illusions.",
  ...
  // ---------------------------- ORCS x HUMAIN ------------------------------
  {
    ...
    description:
      "Hybrides disciplinés dont la force orque est tempérée par une volonté humaine.",
  ...
  },
  {
    ...
    description:
      "Instinctifs et redoutables, ils combinent puissance brute et rapidité humaine.",
  ...
  // --------------------------- INFERNAUX MQ -------------------------------
  {
    ...
    description:
      "Ancêtres infernaux mineurs, spécialisés dans les flammes furtives.",
  ...
  },
  {
    ...
    description:
      "Hybrides austères dont la présence rappelle la désolation.",
  ...
  },
  {
    ...
    description:
      "Leurs ancêtres ont pactisé avec des seigneurs de la destruction.",
    traits: ["Résistance infernale", "Regard brûlant", "Volonté indomptable"],
  },

] as const;

export type MQRaceCore = (typeof MQ_RACES_CORE)[number];
