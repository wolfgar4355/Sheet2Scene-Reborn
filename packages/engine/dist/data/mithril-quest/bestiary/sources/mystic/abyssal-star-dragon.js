...
export const ABYSSAL_STAR_DRAGON = {
    ...
    lairs: [
    // auto-commented "crypte-gigantesque ouverte sur l'espace",
    // auto-commented "plateau suspendu entre deux plans",
    // auto-commented "temple oublié dédié à d'antiques dragons stellaires",
    ],
    summary: "Kryxal-tor, Dragon Abyssal des Étoiles, est un titan draconique qui dévore les constellations et fracture le ciel. Son combat se déroule en deux phases : d’abord un prédateur stellaire enragé, puis un cœur abyssal conscient qui tord la gravité elle-même.",
    encounterDifficulty: "mythic",
    aiProfile: "raid-boss-multi-phase-arena",
    mythicActions: [
    // auto-commented "Au début de chaque round, une zone aléatoire de l'arène est frappée par une pluie de fragments stellaires (terrain dangereux).",
    // auto-commented "À 50% des PV totaux restants (toutes phases confondues), Kryxal-tor déclenche une Onde Gravitationnelle qui repousse ou attire toutes les créatures.",
    // auto-commented "Une fois par combat, il peut annuler un échec de sauvegarde important en se nourrissant d'une constellation proche, modifiant la carte du ciel.",
    ],
    // --------------------------- PHASES --------------------------------------
...
// PHASE 1 — Dragon des Étoiles Noires
{
    ...
    // auto-commented "À ce stade, il fonce en piqué, crache du vide stellaire et bombarde le champ de bataille de météores vivants.",
    // auto-commented "Priorise les lanceurs de sorts et les cibles qui restent statiques ou trop groupées.",
    ...
    ;
    phaseTriggers: [
        // auto-commented "Quand Kryxal-tor tombe à 0 PV pour la première fois, son corps explose en fragments stellaires au lieu de mourir.",
        "L'arène se fracture, révélant un Cœur Abyssal flottant au centre : transition immédiate vers la Phase 2.",
        // auto-commented "Les créatures à courte portée subissent une pluie de débris cosmiques pendant la transition (test de sauvegarde ou dégâts).",
    ];
}
// PHASE 2 — Cœur Abyssal Conscient
{
    ...
    // auto-commented "le champ de bataille devient une singularité contrôlée.",
    // auto-commented "Alterne entre aspiration vers le cœur et ondes de choc répulsives pour séparer le groupe.",
...
// ----------------------------- LOOT --------------------------------------
// auto-commented
// auto-commented "Fragment de Carapace Stellaire (armure légendaire +3, protection accrue contre les dégâts de force et radiants).",
// auto-commented "Cœur d’Amas (focus cosmique, amplifie les sorts de gravité, téléportation et contrôle de terrain).",
