...
export const MQ_THIGHPLATES = [
  ...
  //
  {
    ...
    description:
      "De simples renforts en cuir épais, offrant une protection correcte sans sacrifier la mobilité."
  },

  {
    ...
    description:
      "Une couche rembourrée conçue pour absorber partiellement les coups."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Des pièces légères séparées en plusieurs panneaux pour maximiser l'agilité."
  },

  {
    ...
    eras: ["dark-age"],
    description:
      "Des plaques basiques utilisées par les soldats de milice, lourdes mais fiables."
  },

  {
    ...
    description:
      "Portés dans les régions froides, ils offrent chaleur et un minimum de protection."
  },

  {
    ...
    eras: ["age-of-heroes"],
    description:
      "Des protections souples adaptées aux climats désertiques."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Une jupe fendue renforcée permettant des mouvements fluides pour les archers."
  },

  {
    ...
    eras: ["ancient-age"],
    description:
      "Des plaques en bois cérémoniel durci, offrant une résistance surprenante."
  },

  {
    ...
    eras: ["high-kingdoms"],
    description:
      "Renforcés pour résister au frottement constant de la selle."
  },

  {
    ...
    description:
      "Des lamelles métalliques lacées ensemble pour une protection robuste."
  },
  ...
  //
  {
    ...
    description:
      "Des plaques infusées d’énergie orageuse, réduisant les chocs électriques subis."
  },

  {
    ...
    description:
      "Forgées dans un tissu absorbant la lumière, parfaites pour les assassins et éclaireurs."
  },

  {
    ...
    description:
      "Écorce vivante mouvante, réagissant instinctivement aux attaques."
  },

  {
    ...
    description:
      "Des plaques martelées avec des glyphes anciens, offrant une protection magique."
  },

  {
    ...
    eras: ["mythic-age"],
    description:
      "Forgées à partir de minerai astral infusé de lumière lunaire, incroyablement légères."
  }
] as const;
