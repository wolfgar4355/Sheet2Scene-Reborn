...
export type MythicPhase = {
  ...
  hp: number;
  ac: number;
  role: string; // ex: "mythic-brute-caster", "mythic-controller"
  description: string;
...
export const ABYSSAL_STAR_DRAGON: MythicBoss = {
  ...
  lairs: [
    "crypte-gigantesque ouverte sur l'espace",
    "plateau suspendu entre deux plans",
    "temple oublié dédié à d'antiques dragons stellaires"
  ],

  summary:
    "Kryxal-tor, Dragon Abyssal des Étoiles, est un titan draconique qui dévore les constellations et fracture le ciel. " +
  ...
  mythicActions: [
    "Au début de chaque round, une zone aléatoire de l'arène est frappée par une pluie de fragments stellaires (terrain dangereux).",
    "À 50% des PV totaux restants (toutes phases confondues), Kryxal-tor déclenche une Onde Gravitationnelle qui repousse ou attire toutes les créatures.",
    "Une fois par combat, il peut annuler un échec de sauvegarde important en se nourrissant d'une constellation proche, modifiant la carte du ciel."
  ],
  ...
  phases: [
    // PHASE 1 — Dragon des Étoiles Noires
    {
      ...
      description:
        ...
        "À ce stade, il fonce en piqué, crache du vide stellaire et bombarde le champ de bataille de météores vivants.",
      tactics: [
        "Reste en vol constant, alterne entre bombardements à distance et piqués brutaux sur les cibles isolées.",
        "Priorise les lanceurs de sorts et les cibles qui restent statiques ou trop groupées.",
      ...
      phaseTriggers: [
        "Quand Kryxal-tor tombe à 0 PV pour la première fois, son corps explose en fragments stellaires au lieu de mourir.",
        "L'arène se fracture, révélant un Cœur Abyssal flottant au centre : transition immédiate vers la Phase 2.",
        "Les créatures à courte portée subissent une pluie de débris cosmiques pendant la transition (test de sauvegarde ou dégâts)."
      ]
    },
    ...
    // PHASE 2 — Cœur Abyssal Conscient
    {
      ...
      description:
        "Lorsque la carcasse de Kryxal-tor éclate, elle révèle un noyau stellaire vivant : un Cœur Abyssal " +
        "suspendu dans un réseau d’anneaux d’énergie bleutée. La gravité se déforme, les constellations se plient et " +
        "le champ de bataille devient une singularité contrôlée.",
      tactics: [
        "Abandonne la mobilité classique pour un contrôle total du terrain via distorsions gravitationnelles.",
        "Alterne entre aspiration vers le cœur et ondes de choc répulsives pour séparer le groupe.",
      ...
      phaseTriggers: [
        "Quand le Cœur tombe à 0 PV, Kryxal-tor est définitivement détruit et laisse un vortex instable absorbant lentement l’arène.",
        "Si les PJ accomplissent un rituel de purification pendant le combat, ils peuvent stabiliser le Cœur et transformer la Supernova finale en bénédiction cosmique.",
        "Si le combat dure trop longtemps, le Cœur commence à avaler des fragments de réalité, augmentant progressivement les dégâts de toutes ses attaques."
      ]
    }
  ],
  ...
  loot: [
    "Fragment de Carapace Stellaire (armure légendaire +3, protection accrue contre les dégâts de force et radiants).",
    "Cœur d’Amas (focus cosmique, amplifie les sorts de gravité, téléportation et contrôle de terrain).",
    "Larme de Nova (objet à usage unique : explosion astrale contrôlée, peut renverser l’issue d’un siège ou d’une bataille).",
    "Indices indiquant la localisation d'un autre Dragon Mythique ou d’une forteresse perdue dans le vide entre les étoiles."
  ]
};
