export const MQ_ARTIFACTS_FORBIDDEN = [
    {
        key: "heart_of_the_unmaker",
        label: "Heart of the Unmaker",
        description: "A warped crystalline organ that beats backwards in time. Each pulse distorts the air.",
        type: "artifact",
        category: "forbidden",
        subtype: "entropy",
        metadata: {
    ...
    },
    {
        ...
        description: "A tome written in a language that rearranges itself every time it is read.",
        type: "artifact",
        category: "forbidden",
        subtype: "eldritch",
        metadata: {
    ...
    },
    {
        ...
        description: "A crown made of bone and metal, humming with the hunger of something ancient.",
        type: "artifact",
        category: "forbidden",
        subtype: "hunger",
        metadata: {
    ...
    },
    {
        ...
        description: "A shattered soul vessel leaking grey embers that burn without heat.",
        type: "artifact",
        category: "forbidden",
        subtype: "necrotic",
        metadata: {
    ...
    },
    {
        ...
        description: "A metallic sigil engraved with a star that should not exist. It absorbs starlight.",
        type: "artifact",
        category: "forbidden",
        subtype: "stellar",
        metadata: {
    ...
    },
    {
        ...
        description: "A faceless mask that erases reflections, memories and even voices.",
        type: "artifact",
        category: "forbidden",
        subtype: "identity",
        metadata: {
    ...
    },
    {
        key: "sorrow_engine",
        label: "Sorrow Engine",
        description: "A mechanical heart pulsating with compressed grief. Its ticking echoes like a sob.",
        type: "artifact",
        category: "forbidden",
        subtype: "emotion",
        metadata: {
    ...
    },
    {
        ...
        description: "A long scroll made from an unknown scale-like material, coiling on its own.",
        type: "artifact",
        category: "forbidden",
        subtype: "curse",
        metadata: {
    ...
    },
    {
        key: "black_vessel",
        label: "Black Vessel",
        description: "A voidlike urn that contains swirling shadows and faint screams.",
        type: "artifact",
        category: "forbidden",
        subtype: "void",
        metadata: {
    ...
    },
    {
        ...
        description: "A blood-written parchment that cannot be destroyed by conventional means.",
        type: "artifact",
        category: "forbidden",
        subtype: "pact",
        metadata: {
